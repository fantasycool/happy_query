...
//                 */
////                if (fillLeftTableDefinitionDatas(jsonParseDataParam, datas, me, leftDatas, leftDefinitionDatas))
//                    continue;
//                /**
...
//            //年龄计算
//            DataDefinition age = (DataDefinition) DataDefinitionCacheManager.getValue("age");
//            DataDefinition birthDataDefinition = (DataDefinition) DataDefinitionCacheManager.getValue("birth");
...
//            }
//            DataDefinition bmiDataDefinition = (DataDefinition) DataDefinitionCacheManager.getValue("BMI");
//            DataDefinition weight = (DataDefinition) DataDefinitionCacheManager.getValue("weight");
//            DataDefinition height = (DataDefinition) DataDefinitionCacheManager.getValue("height");
//            //weight, height
...
//            DataDefinition o = DataDefinitionCacheManager.getDataDefinition(Long.valueOf(dataDefinitionId));
//            if (!(o instanceof DataDefinitionCacheManager.NullDataDefinition)) {
...
//    }
//
//    private static boolean fillLeftTableDefinitionDatas(Map<DataDefinition, Row.Value> lr,
...
//            try {
//                DataDefinition definition = (DataDefinition) DataDefinitionCacheManager.getValue(me.getKey().toString());
