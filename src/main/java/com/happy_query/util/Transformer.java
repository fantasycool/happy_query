...
//                return result;
//            }
//            if (d.getDefinitionTypeEnum() == DefinitionType.SELECT) {
//                result = getCodeFromValue(d.getDataOptionList(), s);
//            } else if (d.getDefinitionTypeEnum() == DefinitionType.DATETIME) {
...
//                }
//            }  else if (d.getDefinitionTypeEnum() == DefinitionType.MULTISELECT || d.getDefinitionTypeEnum() == DefinitionType.CHECKBOX) {
